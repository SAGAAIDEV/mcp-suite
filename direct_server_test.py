#!/usr/bin/env python
"""
Direct test runner for Redis server module to achieve 100% test coverage.
This approach completely bypasses pytest and environment validation issues.
"""
...
# Initialize globals that server.py will use
redis_process = None
redis_launched_by_us = False

# Get direct access to server module to modify globals
import src.mcp_suite.redis.server

# Import server module (AFTER mocking all dependencies)
...
class TestRedisServer(unittest.TestCase):
    """Tests for the Redis server module."""
...
if __name__ == "__main__":
    ...
    # Check if 100% coverage was achieved
    if coverage_report < 100:
        print("\nWARNING: Test coverage is less than 100%")
        print("Missing lines:")
